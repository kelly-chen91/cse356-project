    ...
    .post("api/videos", (req, res) => {
        ...
        fs.readFile(path.join(videosPath, "m1.json" ), "utf8", (err, content) => {
            ...
            for (let i = 0; i < count; i++) {
                const videoName = videoNames[Math.floor(Math.random()*videoNames.length)];
            ...
            return res.status(200).json({status: "OK", videos: videoMetadatas, message: "Successfully sent videos"})
        })
    })
